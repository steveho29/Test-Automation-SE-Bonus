...
WebUI.click(findTestObject('Object Repository/Page_Dashboard/span_Site administration (14)'))

WebUI.click(findTestObject('Object Repository/Page_Moodle Administration Search/a_Users (8)'))
...
WebUI.setText(findTestObject('Object Repository/Page_Add new cohort/input_Name_name'), 'New Cohort')
