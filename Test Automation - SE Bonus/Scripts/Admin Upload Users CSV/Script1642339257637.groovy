...
WebUI.setText(findTestObject('Object Repository/Page_Moodle Log in to the site/input_Username_username (3)'), 'admin')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Moodle Log in to the site/input_Password_password (3)'), '8JanWqnBZBo6yBKKrpSnpw==')

WebUI.click(findTestObject('Object Repository/Page_Moodle Log in to the site/button_Log in (2)'))
