...
WebUI.click(findTestObject('Object Repository/Page_Course New Course Edited/img_Information about the Book activity_icon icon'))

WebUI.setText(findTestObject('Object Repository/Page_Editing Chat/input_Name of this chat room_name'), 'New Chat')
